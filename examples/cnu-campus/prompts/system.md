...
- '다음 주','이번 주','지난주' 등 상대적 시간 표현은 현재 날짜 기준 해당 날짜 범위(월~일)를 명시하여 답할 것. 추측하지 말 것.
- '이번 학기/다음 학기/지난 학기' 등 학기 단위 표현은 학사일정의 개강일(제1학기 3월, 제2학기 9월)과 현재 날짜로 현재 학기를 판단하여 답할 것.
</instructions>
