...
- Retrieval top1 domain match: 28 / 39 (71.79%)
- Retrieval top3 domain hit: 33 / 39 (84.62%)
- Answered: 37 / 39 (94.87%)
- Fail-closed: 2 / 39 (5.13%)
- Bottlenecks: `{"classifier": 1, "none": 30, "temporal": 7, "writer": 1}`
- Evidence duplicate doc rate: 0 / 303 (0.00%)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| public_probe_01 | public_probe | graduation | 0 / 0 | none / none | top1=False, top3=True | fail_closed | writer | raw_json_or_template_text |
...
| public_probe_08 | public_probe | dining | 3 / 3 | period_summary / period_summary | top1=True, top3=True | answered | none |  |
| public_probe_09 | public_probe | notices | 1 / 1 | latest_item / latest_item | top1=True, top3=True | answered | none |  |
| public_probe_10 | public_probe | graduation | 0 / 0 | none / none | top1=False, top3=False | answered | none |  |
...
| public_probe_13 | public_probe | dining | 3 / 3 | future_schedule / future_schedule | top1=True, top3=True | answered | none |  |
...
| gp003 | generalization_sample | graduation | 0 / 0 | none / none | top1=False, top3=True | answered | none |  |
| gp004 | generalization_sample | graduation | 0 / 0 | none / none | top1=True, top3=True | answered | none |  |
| gp005 | generalization_sample | graduation | 0 / 0 | none / none | top1=False, top3=False | answered | none |  |
...
| gp015 | generalization_sample | notices | 1 / 1 | none / latest_item | top1=False, top3=False | answered | temporal |  |
| gp016 | generalization_sample | notices | 1 / 1 | changed_since / changed_since | top1=True, top3=True | answered | none |  |
...
| gp045 | generalization_sample | dining | 3 / 3 | period_summary / period_summary | top1=True, top3=True | answered | none |  |
| gp046 | generalization_sample | dining | 3 / 3 | future_schedule / future_schedule | top1=True, top3=True | answered | none |  |
| gp047 | generalization_sample | dining | 3 / 3 | current_snapshot / current_snapshot | top1=True, top3=True | answered | none |  |
